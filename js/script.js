(function (global) {
  ...
  function page(x) {
    ...
    switch (x) {
      ...
      case "about":
        ...
        break;
      case "oplata":
        html = "snippets/oplata.html";
        break;
      case "vozvrat":
        html = "snippets/vozvrat.html";
        break;
      case "order":
        html = "snippets/order.html";
        break;
      case "contacts":
        html = "snippets/contacts.html";
        break;
    }
    return html;
  }
  ...
  js_size_button = function (obj) {
    ...
    if (buttons.length < 2) {
      document.getElementById(buttons_i).style.cssText =
        "color: #ffffff; background: #4a4a4a";
    } else {
      document.getElementById(buttons_i).style.cssText =
        "color: #ffffff; background: #4a4a4a";
      document.getElementById(buttons_i_1).style.cssText =
  ...
  dc.loadCatalogeCollection = function (index, id) {
    ...
    switch (index) {
      case "all":
        html_cat = "snippets/catalog/catalog-collection.html";
        breadcrumbs_cat = "Каталог";
        url_cat = "/cataloge";
        break;
      case "necklace":
        html_cat = "snippets/catalog/category/necklace/necklace-snippet.html";
        breadcrumbs_cat =
          "<span class='breadcrumbs-page'>Цепочки и ожерелья</span>";
        url_cat = "/cataloge/necklace";
        switch (id) {
          case 1:
            html_cat = neck_1.page;
            breadcrumbs_cat_prod = neck_1.breadcrumbs_cat_prod;
            url_cat = "/cataloge/necklace/ozhirel'e-s-podveskami";
            break;
          case 2:
            html_cat = neck_2.page;
            breadcrumbs_cat_prod = neck_2.breadcrumbs_cat_prod;
            url_cat =
              "/cataloge/necklace/serebristoe-ozherel'e-s-padveskoj-v-vide-kompasa";
            break;
          default:
            break;
        }
        break;
      case "cufflinks":
        html_cat = "snippets/catalog/category/cufflinks/cufflinks-snippet.html";
        breadcrumbs_cat = "<span class='breadcrumbs-page'>Запонки</span>";
        url_cat = "/cataloge/cufflinks";
        switch (id) {
          case 1:
            html_cat = cuffl_1.page;
            breadcrumbs_cat_prod = cuffl_1.breadcrumbs_cat_prod;
            url_cat = "/cataloge/cufflinks/zaponki-v-polosku-Paul-Smith";
            break;
          case 2:
            html_cat = cuffl_2.page;
            breadcrumbs_cat_prod = cuffl_2.breadcrumbs_cat_prod;
            url_cat =
              "/cataloge/cufflinks/zaponki-s-kontrastnoj-otdelkoj-DesingB";
            break;
          default:
            break;
        }
        break;
      case "earrings":
        html_cat = "snippets/catalog/category/earrings/earrings-snippet.html";
        breadcrumbs_cat = "<span class='breadcrumbs-page'>Серьги</span>";
        switch (id) {
          case 1:
            html_cat = earr_1.page;
            breadcrumbs_cat_prod = earr_1.breadcrumbs_cat_prod;
            break;
          case 2:
            html_cat = earr_2.page;
      ...
      case "wristwatch":
        html_cat =
          "snippets/catalog/category/wristwatch/wristwatch-snippet.html";
        breadcrumbs_cat = "<span class='breadcrumbs-page'>Часы</span>";
        url_cat = "/cataloge/wristwatch";
        switch (id) {
          case 1:
            html_cat = watch_1.page;
            breadcrumbs_cat_prod = watch_1.breadcrumbs_cat_prod;
            url_cat = "/cataloge/wristwatch/Adidas-Z02-Process";
            break;
          case 2:
            html_cat = watch_2.page;
            breadcrumbs_cat_prod = watch_2.breadcrumbs_cat_prod;
            url_cat = "/cataloge/wristwatch/BOSS-Trophy";
            break;
          default:
            break;
        }
        break;
      case "bracelet":
        html_cat = "snippets/catalog/category/bracelet/bracelet-snippet.html";
        breadcrumbs_cat = "<span class='breadcrumbs-page'>Браслеты</span>";
        switch (id) {
          case 1:
            html_cat = brac_1.page;
    ...
    if (id === 0) {
      $ajaxUtils.sendGetRequest(
        homeHtml,
        function (responseText) {
          document.querySelector("#breadcrumbs-page").innerHTML =
            breadcrumbs_cat;
        },
        false
      );
      ...
      $ajaxUtils.sendGetRequest(
        html_cat,
        function (responseText) {
          document.querySelector(".collection-products_list").innerHTML =
            responseText;

          //url
          history.pushState({}, null, url_cat);
        },
        false
      );
    } else {
      $ajaxUtils.sendGetRequest(
        ...
        function (responseText) {
          ...
          $ajaxUtils.sendGetRequest(
            html_cat,
            function (responseText) {
              document.querySelector("#single-page-content").innerHTML =
                responseText;
              document.querySelector("#breadcrumbs-page").innerHTML =
                breadcrumbs_cat_prod;
    ...
    if (arr.length == 0) {
      ...
      for (var i = 0; i < arr.length; i++) {
        if (arr[i].code === prod.code) {
          console.log(
            "prod.number = " + prod.number + " arr.number = " + arr[i].number
          );
            ...
            for (var i = 0; i < arr.length; i++) {
              ...
              $ajaxUtils.sendGetRequest(
                ...
                function (responseText) {
                  //	setTimeout(() => {
                  document.querySelector("#breadcrumbs-page").innerHTML =
                    "<span class='breadcrumbs-page'>Оформление заказа</span>";
                  document.getElementById(co_count_id).textContent =
                    input_value;
  ...
  js_cart_total = function () {
    ...
    if ($("#courier").is(":checked")) {
      ...
      document
        .getElementById("shipping_address_address")
  ...
  js_filter = function (obj, property, prop_id) {
    ...
    let checkboxs = document.getElementsByClassName(
    ...
    for (let i = 0; i < checkboxs.length; i++) {
      ...
      if (checkboxs[i].checked) {
        ...
        for (let j = 0; j < arr_prod.length; j++) {
          if (
            $(checkboxs).filter(":checked").length > 1 &&
            checkboxs[i].name !== obj.name
          ) {
            console.log(
              "this.name = " + obj.name + " ch_name = " + checkboxs[i].name
            );
          ...
          if (
            $(checkboxs).filter(":checked").length < 2 ||
            (checkboxs[j].name === obj.name &&
              $(checkboxs).filter(":checked").length > 1)
          ) {
            console.log(
              "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! this.name = " +
  ...
  switch_func = function (choice, j) {
    ...
    switch (choice) {
      case "color":
        click = arr_prod[j].color;
        break;
      case "material":
        click = arr_prod[j].material;
        break;
      case "brand":
        click = arr_prod[j].brand;
        break;
      case "size":
        click = arr_prod[j].size;
        break;
    }
    return click;
  };
  ...
  js_button_checkout_submit = function () {
    ...
    for (var i = 0; i < arr.length; i++) {
      ...
      td_price.textContent =
        parseFloat(arr[i].number) * parseFloat(arr[i].price) + ".00\xa0руб";
      ...
      liLast[i].setAttribute(
        "class",
        "co-table-row co-table-row--body co-table-row--striped"
      );
    }
    ...
    $ajaxUtils.sendGetRequest(
      ...
      function (responseText) {
        ...
        $ajaxUtils.sendGetRequest(
          "snippets/order_inf.html",
          function (responseText) {
            document.querySelector(".co-order-information_value").textContent =
              today;
            document.querySelector(".co-price").textContent = total_price;
            document.querySelector(".co-order_history-total_sum").textContent =
              total_price;
            document
              .querySelector(del_id)
              .setAttribute("style", "display: block");
...
var neck_1 = {
  ...
  id_input: "#input_n_1",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Цепочки и ожерелья</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Серебристое многорядное ожерелье с подвесками</span>",
};
var neck_2 = {
  ...
  id_input: "#input_n_2",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Цепочки и ожерелья</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Серебристое ожерелье с подвеской в виде компаса</span>",
};
var cuffl_1 = {
  ...
  id_input: "#input_c_1",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Запонки</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Запонки в полоску Paul Smith</span>",
};
var cuffl_2 = {
  ...
  id_input: "#input_c_2",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Запонки</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Золотистые запонки с контрастной отделкой DesignB</span>",
};
var earr_1 = {
  ...
  id_input: "#input_e_1",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Серьги</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Серьги-гвоздики цвета розового золота с логотипом Emporio Armani</span>",
};
var earr_2 = {
  ...
  id_input: "#input_e_2",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Серьги</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Серебряные серьги-кольца Simon Carter</span>",
};
var watch_1 = {
  ...
  id_input: "#input_w_1",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Часы</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Adidas Z02 Process</span>",
};
var watch_2 = {
  ...
  id_input: "#input_w_2",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Часы</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Часы BOSS Trophy</span>",
};
var brac_1 = {
  ...
  id_input: "#input_b_1",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Браслеты</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Черный браслет с якорем</span>",
};
var ring_1 = {
  name: "Кольцо-печатка",
  size: "Один размер",
  ...
  id_input: "#input_r_1",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Кольца</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Кольцо-печатка</span>",
};
var ring_2 = {
  ...
  id_input: "#input_r_2",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Кольца</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Серебристое кольцо с отделкой</span>",
};
var ring_3 = {
  ...
  id_input: "#input_r_3",
  breadcrumbs_cat_prod:
    "<a href='#' onclick='' class='breadcrumbs-page breadcrumbs-page--home' id='prev-link'>Кольца</a><span class='breadcrumbs-pipe'> / </span><span class='breadcrumbs-page'>Серебряное кольцо с камнем Serge DeNimes Dove</span>",
};
